...
const colores = [
    '#0b4f4f', '#136f63', '#1a8a9e', '#2a9d8f',
    '#5bc4bf', '#7fdbda', '#90e0ef', '#457b9d',
    '#1d3557', '#264653', '#2b9348', '#83c5be',
    '#006d77', '#e29578', '#ffddd2', '#a8dadc'
]
...
const render = () => {
    ...
    props.datos.forEach((barra, i) => {
        ...
        const clipG = barGroup.append('g')
            .attr('clip-path', `url(#${clipId})`)

        const rects = clipG.selectAll('rect.seg')
            .data(segs)
            .enter()
            .append('rect')
            .attr('class', 'seg')
